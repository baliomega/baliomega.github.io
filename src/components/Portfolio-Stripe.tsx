...
interface AdditionalWork {
  id: number
  title: string
  category: 'UI/UX Design' | 'Graphic Design' | 'Social Media'
  description: string
  tags: string[]
  image?: string
}
...
export default function Portfolio() {
  ...
  const additionalWorksAnimation = useScrollAnimation({ threshold: 0.1 })
  ...
  const additionalWorks: AdditionalWork[] = [
    ...
    },
    {
      ...
      description: 'Patient-centered portal for appointment scheduling and medical records access',
      tags: ['Web', 'Healthcare', 'Accessibility', 'HIPAA'],
      image: '/images/projects/uiux_healthcare_portal_1770305511603.png'
    },
    {
      id: 4,
      ...
      image: '/images/projects/graphic_brand_identity_1770305546426.png'
    },
    {
      id: 5,
      category: 'Graphic Design',
      title: 'Marketing Collateral',
      description: 'Print and digital marketing materials for product launch campaigns',
      tags: ['Print Design', 'Marketing', 'Brochures', 'Posters'],
      image: '/images/projects/graphic_marketing_collateral_1770305565418.png'
    },
    {
      id: 6,
      category: 'Graphic Design',
      title: 'Infographic Series',
      description: 'Data visualization and infographics for annual reports and presentations',
      tags: ['Data Viz', 'Infographics', 'Editorial', 'Corporate'],
      image: '/images/projects/graphic_infographic_series_1770305587010.png'
    },
    {
      id: 7,
      category: 'Social Media',
      title: 'Social Media Campaign',
      description: 'Multi-platform social media content for brand awareness and engagement',
      tags: ['Instagram', 'LinkedIn', 'Content Strategy', 'Engagement']
    },
    {
      id: 8,
      category: 'Social Media',
      title: 'Product Launch Graphics',
      description: 'Eye-catching social media graphics for new product announcements',
      tags: ['Social Graphics', 'Product Marketing', 'Visual Content']
    },
    {
      id: 9,
      category: 'Social Media',
      title: 'Animated Social Content',
      description: 'Motion graphics and animated posts for increased social media engagement',
      tags: ['Motion Design', 'Animation', 'Video Content', 'Reels']
    }
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-teal-100">
      ...
      <div id="portfolio-content">
          ...
          <section id="hero" className="relative overflow-hidden pt-12 pb-16 lg:pt-20 lg:pb-32" aria-label="Introduction">
            ...
            <div ref={heroAnimation.ref} className="container mx-auto px-6 lg:px-8 max-w-7xl relative z-10">
              <div className="text-center max-w-5xl mx-auto">
                <div className={`relative inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium mb-8 overflow-hidden shadow-lg shadow-purple-500/20 hover:shadow-xl hover:shadow-purple-500/30 transition-all ${heroAnimation.isVisible ? 'animate-fadeIn' : 'animate-on-scroll'
                  }`}>
                ...
                <h1 className={`text-5xl lg:text-7xl font-bold text-slate-900 mb-6 leading-tight ${heroAnimation.isVisible ? 'animate-fadeInUp delay-200' : 'animate-on-scroll'
                  }`}>
                ...
                <p className={`text-lg lg:text-xl text-slate-600 mb-8 lg:mb-12 max-w-3xl mx-auto leading-relaxed ${heroAnimation.isVisible ? 'animate-fadeInUp delay-500' : 'animate-on-scroll'
                  }`}>
                ...
                <div className="flex flex-wrap gap-4 justify-center">
                  <a
                    ...
                    className={`relative inline-flex items-center gap-2 px-8 py-4 rounded-2xl font-semibold overflow-hidden shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 transition-all hover:scale-105 ${heroAnimation.isVisible ? 'animate-scaleIn delay-800' : 'animate-on-scroll'
                      }`}
                  >
                    <div className="absolute inset-0 bg-white/60 backdrop-blur-xl"></div>
                  ...
                  <a
                    ...
                    className={`relative inline-flex items-center gap-2 px-8 py-4 rounded-2xl font-semibold overflow-hidden shadow-lg shadow-slate-500/20 hover:shadow-xl hover:shadow-slate-500/30 transition-all hover:scale-105 ${heroAnimation.isVisible ? 'animate-scaleIn delay-800' : 'animate-on-scroll'
                      }`}
                  >
        ...
        <main id="main-content">
              ...
              <div className="grid gap-8">
                {projects.map((project, idx) => (
                  <div
                    ...
                    className={`group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all cursor-pointer border border-slate-100 hover:border-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 ${projectsAnimation.isVisible ? `animate-fadeInUp delay-${idx * 100 + 100}` : 'animate-on-scroll'
                      }`}
                  >
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {tools.map((tool, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className={`bg-white p-8 rounded-xl border border-slate-200 hover:border-blue-300 hover:shadow-lg transition-all ${toolsAnimation.isVisible ? `animate-fadeInUp delay-${idx * 100}` : 'animate-on-scroll'
                        }`}
                    >
          ...
          <section ref={additionalWorksAnimation.ref} id="additional-works" className="py-12 lg:py-24 bg-gradient-to-b from-white to-slate-50" aria-labelledby="additional-works-heading">
            <div className="container mx-auto px-6 lg:px-8 max-w-7xl">
              <div className={`text-center mb-8 lg:mb-16 ${additionalWorksAnimation.isVisible ? 'animate-fadeIn' : 'animate-on-scroll'}`}>
                <h2 id="additional-works-heading" className="text-4xl lg:text-5xl font-bold text-slate-900 mb-3 lg:mb-4">Additional Expertise</h2>
                <p className="text-lg lg:text-xl text-slate-600">UI/UX design, graphic design, and creative content</p>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      {work.image ? (
                        ...
                        <div className={`relative w-full h-48 bg-gradient-to-br ${colors.border === 'border-blue-200' ? 'from-blue-50 to-blue-100' : colors.border === 'border-purple-200' ? 'from-purple-50 to-purple-100' : 'from-teal-50 to-teal-100'} flex items-center justify-center`}>
                          <Layout className={`w-16 h-16 ${colors.border === 'border-blue-200' ? 'text-blue-300' : colors.border === 'border-purple-200' ? 'text-purple-300' : 'text-teal-300'}`} />
                        </div>
                      )}

                      {/* Card Content */}
                      <div className="p-6 lg:p-8">
                        <div className={`inline-block px-3 py-1 rounded-full text-xs font-semibold border mb-4 ${colors.badge}`}>
                          {work.category}
                        </div>
                        <h3 className="text-xl font-bold text-slate-900 mb-3">{work.title}</h3>
                        <p className="text-slate-600 mb-4 leading-relaxed">{work.description}</p>
                ...
                <div className="space-y-6 pb-12 lg:-space-y-12 lg:pt-12 lg:pb-24 pl-8 lg:pl-0">
                  {experience.map((exp, idx) => (
                    <div key={idx} className={`relative ${idx % 2 === 0 ? 'lg:pr-[50%] lg:pl-0' : 'lg:pl-[50%] lg:pr-0'}`}>
                      ...
                      <div className={`absolute top-8 -left-[36px] w-2 h-2 rounded-full bg-blue-600 ring-2 ring-white shadow-md z-10 lg:left-1/2 lg:-ml-[5px]`}></div>

                      <div className={`bg-gradient-to-r from-white to-slate-50 p-8 rounded-xl border border-slate-200 hover:border-blue-200 hover:shadow-md transition-all ${idx % 2 === 0 ? 'lg:mr-8' : 'lg:ml-8'} ${experienceAnimation.isVisible ? (idx % 2 === 0 ? `animate-slideInLeft delay-${idx * 100}` : `animate-slideInRight delay-${idx * 100}`) : 'animate-on-scroll'
                        }`}>
                        <div className="mb-4">
              ...
              <div className="max-w-3xl mx-auto text-center">
                ...
                <div className="flex flex-wrap gap-4 justify-center mb-12">
                  <a
                    ...
                    className={`relative inline-flex items-center gap-2 px-8 py-4 rounded-2xl font-semibold overflow-hidden shadow-lg shadow-slate-500/20 hover:shadow-xl hover:shadow-slate-500/30 transition-all hover:scale-105 ${contactAnimation.isVisible ? 'animate-scaleIn delay-100' : 'animate-on-scroll'
                      }`}
                  >
                    <div className="absolute inset-0 bg-white/40 backdrop-blur-xl"></div>
                    <div className="absolute inset-0 bg-gradient-to-br from-white/30 to-slate-100/30"></div>
                  ...
                  <a
                    ...
                    className={`relative inline-flex items-center gap-2 px-8 py-4 rounded-2xl font-semibold overflow-hidden shadow-lg shadow-slate-500/20 hover:shadow-xl hover:shadow-slate-500/30 transition-all hover:scale-105 ${contactAnimation.isVisible ? 'animate-scaleIn delay-200' : 'animate-on-scroll'
                      }`}
                  >
                    <div className="absolute inset-0 bg-white/40 backdrop-blur-xl"></div>
                    <div className="absolute inset-0 bg-gradient-to-br from-white/30 to-slate-100/30"></div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`relative inline-flex items-center gap-2 px-8 py-4 rounded-2xl font-semibold overflow-hidden shadow-lg shadow-slate-500/20 hover:shadow-xl hover:shadow-slate-500/30 transition-all hover:scale-105 ${contactAnimation.isVisible ? 'animate-scaleIn delay-300' : 'animate-on-scroll'
                      }`}
                  >
                    <div className="absolute inset-0 bg-white/40 backdrop-blur-xl"></div>
                    <div className="absolute inset-0 bg-gradient-to-br from-white/30 to-slate-100/30"></div>
                ...
                <div className={`text-sm text-slate-500 ${contactAnimation.isVisible ? 'animate-fadeIn delay-400' : 'animate-on-scroll'}`}>
                  © 2026 Nurul Izwan Dahlan. Design Systems Specialist.
                </div>
              </div>
            </div>
          </section>
